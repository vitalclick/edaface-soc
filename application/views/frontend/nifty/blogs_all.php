                        ...
                        <div class="col-md-6 col-xl-4 mt-3 mb-3">
                            <div class="card radius-10">
                                ...
                                <div class="card-body pt-4">
                                    ...
                                    <h4 class="card-title mb-3"><a class="text-inherit text-muted" href="<?php echo site_url('blog/details/'.slugify($blog['title']).'/'.$blog['blog_id']); ?>"><?php echo $blog['title']; ?></a></h4>
                                    <p class="card-text ellipsis-line-3 text-15">
                                        <?php echo strip_tags(htmlspecialchars_decode($blog['description'])); ?>
                                    </p>
                                    
                                    <a class="fw-600 text-15 text-inherit text-muted" href="<?php echo site_url('blog/details/'.slugify($blog['title']).'/'.$blog['blog_id']); ?>"><?php echo site_phrase('more_details'); ?></a>
