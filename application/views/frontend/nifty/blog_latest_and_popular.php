            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    <?php foreach($latest_blogs->result_array() as $latest_blog): ?>
                        ...
                        <div class="col-md-6 col-xl-4 mt-3 mb-3">
                            <div class="card radius-10">
                                ...
                                <div class="card-body pt-4">
                                    ...
                                    <h4 class="card-title mb-3"><a href="<?php echo site_url('blog/details/'.slugify($latest_blog['title']).'/'.$latest_blog['blog_id']); ?>" class="text-inherit text-muted"><?php echo $latest_blog['title']; ?></a></h4>
                                    <p class="card-text ellipsis-line-3 text-15">
                                        <?php echo strip_tags(htmlspecialchars_decode($latest_blog['description'])); ?>
                                    </p>
                                    
                                    <a class="fw-600 text-inherit text-muted text-15" href="<?php echo site_url('blog/details/'.slugify($latest_blog['title']).'/'.$latest_blog['blog_id']); ?>"><?php echo site_phrase('more_details'); ?></a>
                ...
                <?php if($popular_blogs->num_rows() > 0): ?>
                    <div class="row mt-4">
                            ...
                            <div class="col-md-6 col-xl-4 mt-3 mb-3">
                                <div class="card radius-10">
                                    ...
                                    <div class="card-body pt-4">
                                        ...
                                        <h4 class="card-title mb-3"><a class="text-inherit text-muted" href="<?php echo site_url('blog/details/'.slugify($popular_blog['title']).'/'.$popular_blog['blog_id']); ?>"><?php echo $popular_blog['title']; ?></a></h4>
                                        <p class="card-text ellipsis-line-3 text-15 ">
                                            <?php echo strip_tags(htmlspecialchars_decode($popular_blog['description'])); ?>
                                        </p>
                                        
                                        <a class="fw-600 text-15 text-inherit text-muted" href="<?php echo site_url('blog/details/'.slugify($popular_blog['title']).'/'.$popular_blog['blog_id']); ?>"><?php echo site_phrase('more_details'); ?></a>
                        ...
                        <div class="col-12">
                            <div class="col-12">
                                <a class="float-right btn btn-secondary px-3 fw-600 mb-3" href="<?php echo site_url('blogs'); ?>"><?php echo site_phrase('view_all'); ?></a>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
