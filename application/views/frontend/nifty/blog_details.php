                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-9 top-instructor-details text-md-start">
                                ...
                                <div class="description ellipsis-line-3 text-15">
                        ...
                        <?php foreach($blog_comments->result_array() as $blog_comment): ?>
                            ...
                            <div class="callout callout-light d-block d-md-flex mt-4 mb-4">
                                ...
                                <div class="w-auto px-2">
                                    ...
                                    <div class="w-100 text-15"><?php echo nl2br($blog_comment['comment']); ?></div>
                                    <div class="w-100 text-13px text-muted mt-2 d-flex">
                                        <?php if($blog_comment['updated_date'] > 0): ?>
                                            <span class="d-inline-block me-2 text-13"><i class="far fa-clock"></i> <?php echo site_phrase('updated').' '.get_past_time($blog_comment['updated_date']); ?></span>
                                        <?php else: ?>
                                            <span class="d-inline-block me-2 text-13"><i class="far fa-clock"></i> <?php echo get_past_time($blog_comment['added_date']); ?></span>
                                        <?php endif; ?>
                                    ...
                                    <?php foreach($this->crud_model->get_blog_comments_by_parent_id($blog_comment['blog_comment_id'])->result_array() as $child_comment): ?>
                                        ...
                                        <div class="d-block d-md-flex mt-4">
                                            ...
                                            <div class="w-auto px-2">
                                                ...
                                                <div class="w- text-15"><?php echo nl2br($child_comment['comment']) ?></div>

                                                <div class="w-100 text-13px text-muted mt-2 d-flex">
                                                    <?php if($child_comment['updated_date'] > 0): ?>
                                                        <span class="d-inline-block me-2 text-13"><i class="far fa-clock"></i> <?php echo site_phrase('updated').' '.get_past_time($child_comment['updated_date']); ?></span>
                                                    <?php else: ?>
                                                        <span class="d-inline-block me-2 text-13"><i class="far fa-clock"></i> <?php echo get_past_time($child_comment['added_date']); ?></span>
                                                    <?php endif; ?>
