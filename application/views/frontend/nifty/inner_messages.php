...
<?php
    ...
    <div class="message-details d-show">
        <div class="message-header">
            <a href="<?php echo site_url('home/instructor_page/'.$user_to_show_details['id']); ?>">
                ...
                <?php if ($message['sender'] == $this->session->userdata('user_id')): ?>
                    <div class="message-box-wrap me">
                        <div class="message-box">
                            <div class="time-me"><?php echo date('D, d-M-Y', $message['timestamp']); ?></div>
                            <div class="message-me"><?php echo $message['message']; ?></div>
                        </div>
                    </div>
                <?php else: ?>
        ...
        <div class="message-footer">
            <form class="" action="<?php echo site_url('home/my_messages/send_reply/'.$message_thread_code); ?>" method="post">
                <textarea class="form-control text-success" name="message" placeholder="<?php echo site_phrase('type_your_message'); ?>..."></textarea>
                <button class="btn btn-success float-right mt-3" type="submit"><?php echo site_phrase('send'); ?></button>
            </form>
        </div>
    </div>
<?php endif; ?>
