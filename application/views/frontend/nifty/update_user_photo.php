...
<!-- Hero Section -->
<div class="container">
  <div class="bg-primary rounded mt-4" style="background: url(<?= base_url('assets/frontend/nifty/img/upload.png'); ?>) right bottom no-repeat; background-size: contain;">
      <div class="py-4 px-6">
          ...
          <div class="card mb-5">
            <div class="card-body">
              ...
              <ul class="nav nav-sub nav-sm nav-tabs nav-list-y-2 mb-4">
                ...
                <li class="nav-item ">
                  <a class="nav-link active" href="<?= site_url('home/profile/user_photo'); ?>">
		...
		<div class="card mb-3 mb-lg-5">
	        ...
	        <div class="card-body">
              ...
              <div class="content-update-box">
                  <button type="submit" class="btn btn-primary float-right"><?php echo site_phrase('upload'); ?></button>
              </div>
            </form>
	        </div>
	        <!-- End Body -->
